                    ...
                    return (
                      <TableRow key={i} className="bg-muted/60">
                        ...
                        <Dialog>
                            ...
                            <span className="font-semibold text-[#0090FF] cursor-pointer text-[14px]">{item?.RequestControl}</span>
                            </DialogTrigger>
                            <DialogContent>
                              <DialogHeader>
                        ...
                        <TableCell className=" p-4 text-left text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] [&:has([role=checkbox])]:pl-3">
                          <Button onClick={() => operequesthistorywindow(item?.RequestControl)} className="text-[#fff] rounded-sm bg-[#205D9E] hover:bg-[#205D9E] text-center">History 
